...
{
    public class OptionSetCollectionToIntArrayDto : EntityMapper<OptionSetCollectionToIntArrayDto>
    {
        public OptionSetCollectionToIntArrayDto(Entity entity) : base(entity)
        {
        }
