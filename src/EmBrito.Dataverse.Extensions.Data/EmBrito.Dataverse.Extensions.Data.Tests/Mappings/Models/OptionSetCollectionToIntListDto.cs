...
{
    public class OptionSetCollectionToIntListDto : EntityMapper<OptionSetCollectionToIntListDto>
    {
        public OptionSetCollectionToIntListDto(Entity entity) : base(entity)
        {
        }
