...
{
    public class EntityCollectionToGuidArrayDto : EntityMapper<EntityCollectionToGuidArrayDto>
    {
        public EntityCollectionToGuidArrayDto(Entity entity) : base(entity)
        {
        }
